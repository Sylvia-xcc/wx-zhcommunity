    ...
    methods: {
        ...
        submitSelectDate: function () {
            ...
            if (this.data.datePickerAttr.dateType == 1) {
              ...
              let year = this.data.nlDateMutiIndex[0]+1900;
              let cMonth = this.data.nlMonths[this.data.nlDateMutiIndex[1]];
              let b = 0;
              if (cMonth.indexOf('闰')>-1){
                b=1;
                cMonth = cMonth.slice(1);
              }
              let month = nlMonth.indexOf(cMonth)+1;
              month = parseInt(month)<10?'0'+month:month;
              let day = this.data.nlDateMutiIndex[2]+1;
              day = parseInt(day) < 10 ? '0' + day : day;
              dateNum = year+'-'+month+'-'+day+'-'+b;
              // console.log('--------------- ', this.data.nlDateMutiIndex, dateNum, cMonth)
            }
            this.closeDatePickerPlus();
            var myEventDetail = {
                dateStr: date,
