...
//         })
//       }, 500)
//       websocket.send('{ "content": "' + this.data.message + '", "type":"text", "tid": "' + 5 + '" }')
//       this.bottom()
//     }
//   },
//   //监听input值的改变
...
//                 increase: false
//               })
//               websocket.send('{"images":"' + res.data + '","date":"' + util.formatTime(new Date()) + '","type":"image","nickName":"' + that.data.userInfo.nickName + '","avatarUrl":"' + that.data.userInfo.avatarUrl + '"}')
//               that.bottom()
//             }
//           }
//         })
